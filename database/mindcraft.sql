...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 20, 2025 at 09:00 PM
...
DROP TABLE IF EXISTS `mentor_settings`;
...
CREATE TABLE `transactions` (
  ...
  KEY `fk_transaction_payment_method` (`payment_method`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
-- Untuk kategori kursus (BUAT DULU UNTUK FOREIGN KEY)
--
...
-- ========================================
-- FOREIGN KEY CONSTRAINTS (SETELAH SEMUA TABLE DIBUAT)
-- ========================================
